...
def b2():
    ...
    entry= Entry(ai, font=('Comic Sans MS','10','bold'),width= 40,bd=0)
    entry.focus_set()
    entry.pack()
    tk.Button(ai, text= "Okay",font=('Comic Sans MS','10','bold'),bg='black',fg='white',bd=10,width= 10, command= date_entry).pack(pady=20)
    date_entry()
    print(a)
    Label(ai,text=a,font=('Comic Sans MS','30','bold'),bg="white",fg='black').pack()
    ai.mainloop()
