...
if len(AbDict['roll'])==0:
    ...
    l1="DATE".ljust(20),mydate
    l2="number on roll".ljust(20)
    l3="Today's absentees : "
    l4="Roll".ljust(6),"Name".ljust(30)
...
eg=tk.Tk()
eg.geometry("500x500")
label=tk.Label(eg,text=b)
label1=tk.Label(eg,text=l1)
label2=tk.Label(eg,text=l2)
label3=tk.Label(eg,text=l3)
label4=tk.Label(eg,text=l4)
